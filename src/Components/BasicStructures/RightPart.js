...
const RightPart = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Switch>
          <Route exact path="/sobre" component={AboutRoute} />
          <Route exact path="/tecnologias" component={SkillsRoute} />
          <Route exact path="/projetos" component={ProjectsRoute} />
          <Route exact path="/contato" component={ContactRoute} />
        </Switch>
      </Grid>
